...
@interface ManifestXoomlParser()

@end

@implementation ManifestXoomlParser
...
+(NSData *) convertImageNoteToXooml:(BulletinBoardNote *)note{
    ...
    NSString *imageName = [ManifestXoomlParser getImageFileName:note];    //create the association note and its attributes
