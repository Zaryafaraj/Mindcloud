...
- (void)testNoteCreate
{
    CollectionNote * note =  [XoomlManifestParser xoomlNoteFromXML:xml];
...
- (void) testXoomlCreationFromNote
{
    ...
    NSData * createdXooml = [XoomlManifestParser convertNoteToXooml: actualNote];
    CollectionNote * expectedNote = [XoomlManifestParser xoomlNoteFromXML:createdXooml];
