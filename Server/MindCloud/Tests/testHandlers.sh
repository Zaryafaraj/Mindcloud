...
curl -F "file=@XooML.xml;filename=Xooml.xml" -F "collectionName=alites65" http://localhost:8000/04B08CB7-17D5-493A-8ED1-E086FDC1327E/Collections/curl -F "file=@XooML.xml;filename=Xooml.xml" -F "collectionName=alites65" http://localhost:8000/04B08CB7-17D5-493A-8ED1-E086FDC1327E/Collections/
...
siege http://localhost:8000/Authorize/04B08CB7-17D5-493A-8ED1-E086FDC1327E -c100 -t20s -v